...
mkdir: Given a directory path that does not exist, you should make 
a new directory according to the path. 
...
and users will not attempt to retrieve file content or list a directory 
