...
Similarily, element with id = 3 from a has a value 7, 
and element with id = 2 from b has a value 3. These also add up to 10. 
...
def findPairs(a, b, target):
    ...
    while l < len(a) and r >= 0:
        if a[l][1] + b[r][1] > target:
            ...
            cloest = min(diff, cloest)
            dic[cloest].append(a[l][0], b[r][0])
            r -= 1
    return dic[cloest]
